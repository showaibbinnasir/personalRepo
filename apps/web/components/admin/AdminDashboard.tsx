...
const fields = {
  ...
  projects:[{key:"title",label:"Project title"},{key:"category",label:"Category"},{key:"summary",label:"Short summary",type:"textarea" as const,full:true},{key:"description",label:"Full description",type:"textarea" as const,full:true},{key:"tech",label:"Technologies",type:"csv" as const,full:true},{key:"imageUrl",label:"Cover image",type:"image" as const,full:true},{key:"liveUrl",label:"Live URL"},{key:"githubUrl",label:"GitHub URL"},{key:"featured",label:"Featured project",type:"checkbox" as const}],
